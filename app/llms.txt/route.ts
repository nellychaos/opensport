...
- [Providers reference](https://opensport.dev/docs/providers): BaseProvider interface, all built-in providers (Mock, PremierLeague, Massey, Stake, Cloudbet, Polymarket, NBA, Kalshi, and more), building custom providers
